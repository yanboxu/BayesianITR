...
#' @export
plot_sim_data <- function(sim_data){
  ...
  for(k in 1:K_u){
    ...
    mean_normal_dynamics = mvrnorm(1,mean_normal_dynamics,mean_KK)
...
#' @export
plot_model_fit <-function(chain, start_iter, tol_iter, prior_unit, train_data){
